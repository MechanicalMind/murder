...
pt.spectateFailed = "Вы не можете наблюдать. Вы живы." -- Вы не мертвы звучит как пародия на зомбаря (Undead), пожалуй лучше заменю аналогом

pt.murdererDisconnect = "У убийцы RageQuit!" -- RageQuit - непереводимая "Игра слов", не переводить же мне "ВЫШЕЛ В ЯРОСТИ", или же вовсе "СЛИЛСЯ"
...
pt.scoreboardPing = "Ping" -- Не перевожу, в виду того что "Пинг" - уже устоявшееся выражение
...
pt.scoreboardActionUnmute = "Снять заглушку" -- Гаг и ангаг, как же меня заебало. Не затычкой же называть

pt.endroundMurdererQuit = "Свидетели победили! Убийца вышел" -- Rage quit, снова. Можете считать это адаптацией
...
pt.adminPanel = "Панель Администратора" -- { Она, к слову, говнецо... Лучше бы на ULX команды было, чем так, имхо }

pt.spectating = "Наблюдение"

pt.adMelonbomberWhy = "Почему бы не попробовать "
pt.adMelonbomberBy = " игровой режим от создателя Murder" -- Murder - название режима, являющееся уже "устоявшимся".
...
// ttt_traitor_button compatibility for TTT maps -- Совместимость для Enitity "ttt_traitor_button" для TTT-карт
pt.ttt_tbut_single  = "Одноразово"
pt.ttt_tbut_reuse   = "Многоразово"
pt.ttt_tbut_retime  = "Многоразовое: через {num} сек" -- Тут нужно проверить контекст.
