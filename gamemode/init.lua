...
GM.DelayAfterEnoughPlayers = CreateConVar("mu_delay_after_enough_players", 10, bit.bor(FCVAR_NOTIFY), "How long (in seconds) should we wait to start the round after enough players have joined?" )
